...
//		queryLog : rootPath + "/log/query",
		queryLog : rootPath + "/log/queryLoginLog",
...
//		Co.gridRowNumberer(),
		...
		{header : "操作时间（ms）", dataIndex : "operTimes", width : 110, hidden : false},
		{header : "请求地址", dataIndex : "requestPath", width : 300, hidden : true},
		{header : "操作模块", dataIndex : "operModule", width : 80, hidden : true},
		{header : "请求参数", dataIndex : "requestParams", width : 1000, hidden : true},
