...
Ext.onReady(function() {
	...
	var selectedRoleTab = false;//用户新增，修改时是否选中过角色Tab。如果没有选中过角色Tab则不进行修改用户绑定的角色
...
//					}
		...
		//是否覆盖原有的角色
		xtype : "hiddenfield",
		id : "overrideSourceRole",
		name : "overrideSourceRole"
	}],{
		border : false,
		frame : false
	});
...
//				rePwd.setVisible(pwdVisible);
	...
	function saveUser() {
		Ext.getCmp("overrideSourceRole").setValue(!selectedRoleTab);
